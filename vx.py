...
def compute_vx(params: Dict[str, float]) -> Dict[str, float]:
    """Calcule V(x) et V_conf selon la spécification Vx.md.
    Clés attendues: p,I,E,X,v,R,H,D,K,C,s (toutes optionnelles avec défauts).
    """
...
if __name__ == "__main__":
    example = {
        "p": 0.65, "I": 8, "E": 9, "X": 8, "v": 8, "R": 6, "H": 4, "D": 4, "K": 5, "C": 0.7, "s": 50
    }
